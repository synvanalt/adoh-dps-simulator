...
def get_default_build_config():
    ...
    return {
        ...
        'DUAL_WIELD': default_cfg.DUAL_WIELD,
        'CHARACTER_SIZE': default_cfg.CHARACTER_SIZE,
        'TWO_WEAPON_FIGHTING': default_cfg.TWO_WEAPON_FIGHTING,
        'AMBIDEXTERITY': default_cfg.AMBIDEXTERITY,
        'IMPROVED_TWF': default_cfg.IMPROVED_TWF,
        'CUSTOM_OFFHAND_WEAPON': default_cfg.CUSTOM_OFFHAND_WEAPON,
        'OFFHAND_WEAPON': default_cfg.OFFHAND_WEAPON,
        'OFFHAND_AB': default_cfg.OFFHAND_AB,
        'OFFHAND_KEEN': default_cfg.OFFHAND_KEEN,
        'OFFHAND_IMPROVED_CRIT': default_cfg.OFFHAND_IMPROVED_CRIT,
        'OFFHAND_OVERWHELM_CRIT': default_cfg.OFFHAND_OVERWHELM_CRIT,
        'OFFHAND_DEV_CRIT': default_cfg.OFFHAND_DEV_CRIT,
        'OFFHAND_WEAPONMASTER_THREAT': default_cfg.OFFHAND_WEAPONMASTER_THREAT,
