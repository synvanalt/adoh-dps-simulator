...
class Config:
    ...
    AB_PROGRESSIONS: Dict[str, Any] = field(default_factory=lambda: {
        ...
        "Monk 6APR & Dual-Wield":                     [0, -3, -6, -9, -12, -15, "dw_hasted", 0, -5],
        "Monk 6APR & Dual-Wield & Flurry":            [0, -3, -6, -9, -12, -15, "dw_hasted", "dw_flurry", 0, -5],
        "Monk 6APR & Dual-Wield & B.Speed":           [0, -3, -6, -9, -12, -15, "dw_hasted", "dw_bspeed", 0, -5],
        "Monk 6APR & Dual-Wield & Flurry & B.Speed":  [0, -3, -6, -9, -12, -15, "dw_hasted", "dw_flurry", "dw_bspeed", 0, -5],
